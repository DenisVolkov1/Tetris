...
public class CurveStickRight extends Figure {
    public CurveStickRight(AnchorPane root,double rateFigures) {
    ...
    public double[] getNextCoordinateRotation() {
        ...
        switch (numberPosition) {
...

            {
                ...
                nextCoordinateArray[2] = boxs[1].getTranslateX() + 2 * 37;
...

            {
                ...
                nextCoordinateArray[3] = boxs[1].getTranslateY() - 2 * 37;
